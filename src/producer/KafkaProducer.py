...
class Producer:
    def __init__(self, serveruri) -> None:
        ...
        self.producer_bootstrap_servers = ["pipe-kafka-controller-0.pipe-kafka-controller-headless.kafkastreamingdata.svc.cluster.local:9092","pipe-kafka-controller-1.pipe-kafka-controller-headless.kafkastreamingdata.svc.cluster.local:9092","pipe-kafka-controller-2.pipe-kafka-controller-headless.kafkastreamingdata.svc.cluster.local:9092"]
        # json.loads(serveruri[0])
        ...
        additional_args = {'value_serializer': self.serializer.str_serializer, 'acks': 1, 'linger_ms': 100,
                           'compression_type': 'lz4', 'batch_size': 16384, **producer_config_args}
    ...
    def ukrain_process(self, filenames, topictitle, nprod, num_topics, podindex, prodindex, batchsize, column_range):
